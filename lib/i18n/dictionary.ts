...
export const dictionary = {
  ...
  personalPage: dict({
    ...
    captureShare: { en: "Share this ↗", th: "แชร์การ์ดนี้ ↗" },
    captureHintDesktop: { en: "Share this ↗", th: "แชร์การ์ดนี้ ↗" },
    ...
    generateStory: { en: "Share the whole plan ↗", th: "แชร์แผนทั้งหมด ↗" },
  ...
  share: dict({
    ...
    shareToStory: { en: "Share this ↗", th: "แชร์การ์ดนี้ ↗" },
    savedOpenInstagram: {
  ...
  tripEdit: dict({
    centerLabel: { en: "Editing {title}", th: "กำลังแก้ไข {title}" },
    title: { en: "Edit trip", th: "แก้ไขทริป" },
    subtitle: {
      en: "Change the route, who's coming, what's ready, and what's still on the list.",
      th: "เปลี่ยนเส้นทาง ใครไปด้วย อะไรพร้อมแล้ว และอะไรที่ยังอยู่ในลิสต์",
    },
    titleField: { en: "Title", th: "ชื่อเรื่อง" },
    roughTiming: { en: "Rough timing", th: "ช่วงเวลาคร่าว ๆ" },
    countries: { en: "Countries", th: "ประเทศ" },
    countriesHint: { en: "Comma-separated.", th: "คั่นด้วยจุลภาค (,)" },
    summary: { en: "Summary", th: "รายละเอียดโดยสรุป" },
    visibility: { en: "Visibility", th: "การมองเห็น" },
    status: { en: "Status", th: "สถานะ" },
    statusPlanning: { en: "Planning", th: "กำลังวางแผน" },
    statusConfirmed: { en: "Confirmed", th: "ยืนยันแล้ว" },
    statusCompleted: { en: "Completed", th: "เสร็จสิ้นแล้ว" },
    statusCancelled: { en: "Cancelled", th: "ยกเลิกแล้ว" },
    theRoute: { en: "The route", th: "เส้นทาง" },
    legPlacePlaceholder: { en: "Osaka", th: "โอซาก้า" },
    addLeg: { en: "+ Add a stop", th: "+ เพิ่มจุดแวะ" },
    details: { en: "Details", th: "รายละเอียด" },
    goingWith: { en: "Going with", th: "ไปกับ" },
    mainEvent: { en: "Main event", th: "อีเวนต์หลัก" },
    readyMeter: { en: "Ready meter (0–100)", th: "มิเตอร์ความพร้อม (0–100)" },
    beforeWeGo: { en: "Before we go", th: "ก่อนไป" },
    checklistPlaceholder: { en: "Book flights", th: "จองตั๋วเครื่องบิน" },
    noteSection: { en: "Note", th: "โน้ต" },
    note: { en: "Note", th: "โน้ต" },
    attributedTo: { en: "— attributed to", th: "— โดย" },
    saveChanges: { en: "Save changes", th: "บันทึกการเปลี่ยนแปลง" },
    saving: { en: "Saving…", th: "กำลังบันทึก…" },
